...
<body>
  ...
  <div class="image-container set-full-height" style="background-image: url('assets/img/luxury-working-room-in-executive-office.jpg')">
              ...
              <form role="form" method="post" action="{{ route('register') }}">
                ...
                <div class="tab-content">
                      ...
                      <div class="col-sm-6 col-sm-offset-2">
                        <div class="input-group">
                          ...
                          <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} label-floating">
                            <label class="control-label">Votre Nom et Prénom <small>(required)</small></label>
                  ...
                  <div class="tab-pane" id="account">
                    <h4 class="info-text"> veuillez remplir toutes les données du formulaire </h4>
                    <div class="row">
                      <div class="col-sm-8 col-sm-offset-2">
                  ...
                  <div class="tab-pane" id="address">
                    <div class="row">
                      ...
                      <div class="col-sm-8 col-sm-offset-1 ">
                        <div class="form-group label-floating">
                          <label class="control-label">URL société (partie de l’URL ne peut être modifié</label>
