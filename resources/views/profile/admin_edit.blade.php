@extends('layouts.admin_app', ['title' => __('Admin Profile')])

@section('content')
@include('users.partials.admin_header', [
            ...
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('admin.profile.update') }}" autocomplete="off">
                        ...
                        <h6 class="heading-small text-muted mb-4">{{ __("les information de l'admin") }}</h6>
