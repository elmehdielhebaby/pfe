            ...
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('user.profile.update') }}" autocomplete="off">
                        ...
                        <h6 class="heading-small text-muted mb-4">{{ __("Les informations d'utilisateur") }}</h6>
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                ...
                                <input type="tel" name="phone" id="input-phone" class="form-control form-control-alternative{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="{{ __('Téléphone') }}" value="{{ old('phone', $etablissement->phone) }}" required>
                    ...
                    <hr class="my-4" />
                    <form method="post" action="{{ route('user.profile.password') }}" autocomplete="off">
                        @csrf
                        @method('put')
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-current-password">{{ __('Le mot de passe actuel') }}</label>
