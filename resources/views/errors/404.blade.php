...
<body class="landing-page">
    ...
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light py-2">
        <div class="container">
            <a class="navbar-brand mr-lg-5" href="/user/home">
    ...
    <div class="">
        ...
        <div class="section section-hero section-shaped">
                    ...
                    <div class="col px-0">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-9 text-center">
                                <h1 class="text-white display-1 " style="font-size: 264px;">404</h1>
                                <h2 class="display-4 font-weight-normal text-white">Page Not Found</h2>
                                <br>
                                <a type="button" class="btn btn-success text-white whith-2" href="/"> Retour </a>
                                <br>
                                <br>
                                <br>
                                <br><br>
            ...
            <div class="separator separator-bottom separator-skew zindex-100">
                <svg x="0" y="0" viewBox="0 0 2560 100" preserveAspectRatio="none" versionf </div>
            </div>
            <div class="text-center text-white">
                &copy; {{ now()->year }} <a href="" class="font-weight-bold ml-1 text-white" target="_blank">HADDADA</a> &amp;
                <a href="" class="font-weight-bold ml-1 text-white" target="_blank">EL HEBABY</a>
